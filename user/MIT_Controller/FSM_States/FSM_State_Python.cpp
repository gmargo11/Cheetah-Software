 ...
 */
template <typename T>
FSM_State_Python<T>::FSM_State_Python(ControlFSMData<T>* _controlFSMData)
...
template <typename T>
void FSM_State_Python<T>::onEnter() {
 ...
 */
template <typename T>
void FSM_State_Python<T>::run() {
  // Call the locomotion control logic for this iteration
  //printf("[FSM_State_Python] Locomotion Control Step!");
 ...
 */
template <typename T>
FSM_StateName FSM_State_Python<T>::checkTransition() {
  // Get the next state
  iter++;
 ...
 */
template <typename T>
TransitionData<T> FSM_State_Python<T>::transition() {
  // Switch FSM control mode
...
template<typename T>
bool FSM_State_Python<T>::locomotionSafe() {
 ...
 */
template <typename T>
void FSM_State_Python<T>::onExit() {
 ...
 */
template <typename T>
void FSM_State_Python<T>::LocomotionControlStep() {
 ...
 */
template <typename T>
void FSM_State_Python<T>::StanceLegImpedanceControl(int leg) {
...
// template class FSM_State_Python<double>;
template class FSM_State_Python<float>;
