...
class CheetahSimulator:
    def __init__(self, dt, initial_coordinates):
        ...
        self.cheetah.set_actuation_limits(18*np.ones(18), -18*np.ones(18)) # adjust
    ...
    def add_heightmap_rand(self):
        heightmap = self.world.add_heightmap(x_samples=50,
                                             ...
                                             x_center=0.0,
                                             y_center=0.0,
                                             heights=np.random.rand(50*50) * 0.04,
...
class WBC_MPC_Controller:
	...
	# initialize controllers
        ...
        self.nmpc = NeuralMPCLocomotion(dt, (int)(27 / (1000. * dt)), self.cheetah_ctrl.userparams)
    ...
    def __call__(self):
        ...
        self.wbc_data.setBodyDes(self.nmpc.pBody_des, self.nmpc.vBody_des, self.nmpc.aBody_des, self.nmpc.pBody_RPY_des, self.nmpc.vBody_Ori_des)
        ...
        for i in range(4):
           ...
           self.wbc_data.setFootDes(i, self.nmpc.get_pFoot_des(i), self.nmpc.get_vFoot_des(i), self.nmpc.get_aFoot_des(i), self.nmpc.get_Fr_des(i))
        self.wbc_data.setContactState(self.nmpc.contact_state)
