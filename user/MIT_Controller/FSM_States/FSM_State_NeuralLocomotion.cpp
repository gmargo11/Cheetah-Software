...
void FSM_State_NeuralLocomotion<T>::run() {
  ...
  //printf("[FSM_State_NeuralLocomotion] Locomotion Control Step!");
...
template<typename T>
bool FSM_State_NeuralLocomotion<T>::locomotionSafe() {
 ...
 */
template <typename T>
void FSM_State_NeuralLocomotion<T>::LocomotionControlStep() {
 ...
 */
template <typename T>
void FSM_State_NeuralLocomotion<T>::StanceLegImpedanceControl(int leg) {
