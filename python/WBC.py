...
def run_WBC(robotparams, userparams, stateEstimator, lc, lc_data, fsm_data):
...
# leg data
q, qd, p, v, J, tauEstimate = np.zeros(3), np.zeros(3), np.zeros(3), np.zeros(3), np.zeros(3), np.zeros(3)
J = np.zeros((3, 3))
...
legControllerData.q, legControllerData.qd, legControllerData.p, legControllerData.v, legControllerData.J, legControllerData.tauEstimate = q, qd, p, v, J, tauEstimate
legControllerData.setQuadruped(cheetah)
