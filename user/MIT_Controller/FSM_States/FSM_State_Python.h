#ifndef FSM_State_Python_H
#define FSM_State_Python_H
 ...
 */
template <typename T>
class FSM_State_Python : public FSM_State<T> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  FSM_State_Python(ControlFSMData<T>* _controlFSMData);
